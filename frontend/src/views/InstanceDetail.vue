<template>
  <div class="d-flex">
    ...
    <main id="main-content">
      <AppHeader :page-title="instance?.name || 'Loading...'" />
        ...
        <div class="d-flex justify-content-between align-items-center pb-2 mb-3 border-bottom flex-wrap">
          <div class="d-flex align-items-center me-3 mb-2 mb-md-0">
            <span class="badge bg-secondary" id="instance-stats-badge">
              CPU: {{ stats.cpu || '--' }}% | Mem: {{ stats.memory || '--' }} MB
            </span>
          </div>
             ...
             <div class="btn-group me-2">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="#" @click.prevent="performAction('stop')">Stop (SIGTERM)</a></li>
                        <li><a class="dropdown-item" href="#" @click.prevent="performAction('terminate')">Terminate (SIGKILL)</a></li>
                    </ul>
                </div>
            </div>
            <div class="btn-group me-2">
                 <div class="btn-group">
                    <button type="button" class="btn btn-warning dropdown-toggle" data-bs-toggle="dropdown" :disabled="instance.status !== 'running'">
                       <i class="bi bi-arrow-clockwise me-1"></i><span>Restart</span>
                    </button>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="#" @click.prevent="performAction('restart')">Restart</a></li>
                        <li><a class="dropdown-item" href="#" @click.prevent="performAction('force-restart')">Force Restart</a></li>
                    </ul>
                </div>
            </div>
        ...
        <div id="terminal-container">
            ...
            <div v-else class="d-flex align-items-center justify-content-center h-100">
                <div class="text-center">
                    <p class="fs-4 text-muted">Instance is stopped.</p>
      ...
      <div v-else class="text-center p-5">
        ...
        <p>The instance you are looking for does not exist or you may not have permission to view it.</p>
