...
import { checkInstancePermission, requireInstancePermission } from '../middleware/permissions.js';
...
router.put('/:id', checkInstancePermission, requireInstancePermission('full-control'), instanceController.updateInstance);
